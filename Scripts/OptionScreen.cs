...
public class OptionScreen : GameManager
{
    ...
    public Button ControlTab { get; private set; }
    public Image ControlPanel { get; private set; }
    ...
    void Start()
    {
        ...
        ControlTab = GameObject.Find("Tab_Control").AddComponent<Button>();
        ControlTab.onClick.AddListener(Open_ControlTab);
        ...
        ControlPanel = GameObject.Find("Panel_Control").GetComponent<Image>(); ControlPanel.gameObject.SetActive(false);
    }
